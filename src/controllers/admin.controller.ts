...
import {
    countUserActiveChallenges,
    countAllActiveChallenges,
    countUserActiveSessions,
    countAllActiveSessions
} from '../services/redis.service.js';

export const handleCountUserActiveChallengesReq = async (
    req: Request,
    res: Response,
    next: NextFunction
): Promise<void> => {
...
export const handleCountAllActiveChallengesReq = async (
    req: Request,
    res: Response,
    next: NextFunction
): Promise<void> => {
...
export const handleCountUserActiveSessionsReq = async (
    req: Request,
    res: Response,
    next: NextFunction
): Promise<void> => {
...
export const handleCountAllActiveSessionsReq = async (
    req: Request,
    res: Response,
    next: NextFunction
): Promise<void> => {
